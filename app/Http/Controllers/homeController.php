...
class homeController extends Controller
{
    public function index()
    {
        ...
        $metalCount = DB::table('dataKaryawan')->select(DB::raw('count(*) as total,idBagian'))->whereNull('km')->whereNotNull('idBagian')->where('idPerusahaan', 1)->groupBy('idBagian')->orderBy('idBagian')->get()->toArray();
        $data = [
