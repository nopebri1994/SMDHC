    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ URL::to('/') }}/login/prosesLogin" method="get">
                    <div class="input-group mb-3">
                        <input type="text" name="nik"
                            class="form-control  {{ $errors->has('nik') ? 'is-invalid' : '' }}" placeholder="NIK">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="pass"
                            class="form-control  {{ $errors->has('pass') ? 'is-invalid' : '' }}" placeholder="Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
