                ...
                <div class="col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">Kode Jam Kerja</div>
                                    <div class="col-md-3">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4 pt-md-4"><strong>Senin - Jumat</strong></div>
                                    <div class="col-md-4">
                                        Masuk :
                                        <input type="time" name="jamMasukSJ" id="jamMasukSJ" class="form-control">
                                    </div>
                                    <div class="col-md-4">
                                        Pulang :
                                        <input type="time" name="jamPulangSJ" id="jamPulangSJ" class="form-control">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4 pt-md-4"><strong>Sabtu</strong></div>
                                    <div class="col-md-4">
                                        Masuk :
                                        <input type="time" name="jamMasukS" id="jamMasukS" class="form-control">
                                    </div>
                                    <div class="col-md-4">
                                        Pulang :
                                        <input type="time" name="jamPulangS" id="jamPulangS" class="form-control">
                                    </div>
                                </div>
...
@section('js')
    <script>
        ...
        const getData = (page) => {
            $.ajax({
                    url: "jam-kerja/tabelData?page=" + page,
                    type: "get",
                    datatype: "html",
                })
                .done(function(data) {
